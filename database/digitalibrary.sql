...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2024 at 05:38 AM
...
(10, 13, 'Komunikasi Keluarga Perspektif Islam', 'Rasya', 'AL-FALAH', '2020'),
(11, 14, 'Hitung Cepat', 'Jerome', 'Garena', '2016'),
(12, 15, 'Newton', 'Newton', 'NASA', '2000');
...
(16, 11, 10, '2024-04-16', '2024-04-20', 'dikembalikan'),
(17, 11, 11, '2024-07-17', '2024-08-14', 'dikembalikan');
...
(9, 'Aziiz Nur Afghani', 'aziz', 'b85dc795ba17cb243ab156f8c52124e1', 'aziz123@gmail.com', 'jln.pacul', 'admin'),
(10, 'Azriel', 'azil', 'dc729ac626ecbb0b0835325382117cb5', 'azriel1@gmail.com', 'jln.pahlawan', 'petugas'),
(11, 'rudi', 'rudi', '1755e8df56655122206c7c1d16b1c7e3', 'rudi@gmail.com', 'lebak', 'peminjam');
...
--
ALTER TABLE `koleksipribadi`
  ADD CONSTRAINT `koleksipribadi_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`id_user`);
